...
mixin _$LoginState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(LoginResponseBody data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(LoginResponseBody data)? success,
...
abstract class _$$LoginSuccessImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({LoginResponseBody data});
}
...
abstract class LoginSuccess<T> implements LoginState<T> {
  const factory LoginSuccess(final LoginResponseBody data) =
      _$LoginSuccessImpl<T>;

  LoginResponseBody get data;
