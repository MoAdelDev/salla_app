        ...
        SizedBox(
          ...
          child: CustomContainerTile(
            child: Column(
              ...
              children: [
                Text(
                  '${context.locale.orderTitle} #${order.id}',
                  style: AppTexts.text16BlackLatoBold,
                ),
                verticalSpace(5.0),
                Text(
                  '${context.locale.placedOnTitle}: ${order.date}',
                  style: AppTexts.text14BlackLatoRegular,
                ),
                verticalSpace(5.0),
                Text(
                  '${context.locale.nOfItemsTitle}: ${order.products.map((e) => e.quantity).reduce((value, element) => value + element)}',
                  style: AppTexts.text14BlackLatoRegular,
                ),
                verticalSpace(5.0),
                Text(
                  '${context.locale.totalTitle}: ${double.parse(order.total.toString()).toStringAsFixed(2)} EGP',
                  style: AppTexts.text14BlackLatoRegular,
                ),
              ],
            ),
